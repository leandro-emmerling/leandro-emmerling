...
|---|---|---:|
| [libft](https://github.com/leandro-emmerling/libft) | Custom C standard library reimplementation | C |
| [printf](https://github.com/leandro-emmerling/printf) | Recreating ft_printf from scratch | C |
| [get_next_line](https://github.com/leandro-emmerling/get_next_line) | Line-by-line file reading with static buffers | C |
| [Born2beRoot](https://github.com/leandro-emmerling/Born2beRoot) | Linux server setup & system administration | Bash |
| [push_swap](https://github.com/leandro-emmerling/push_swap) | Sorting algorithm with constrained instruction set | C |
